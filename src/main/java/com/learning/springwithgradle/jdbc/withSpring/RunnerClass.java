package com.learning.springwithgradle.jdbc.withSpring;

import com.learning.springwithgradle.jdbc.withSpring.dao.CityDao;
...
public class RunnerClass {
    ...
    public static void main(String[] args) {
        ...
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("jdbc.withSpring/bean.xml");
